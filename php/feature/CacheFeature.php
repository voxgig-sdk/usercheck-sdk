...
class UsercheckCacheFeature extends UsercheckBaseFeature
{
    ...
    private function _through(UsercheckContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
