...
class UsercheckProxyFeature extends UsercheckBaseFeature
{
    ...
    public function init(UsercheckContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UsercheckContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
