...
class UsercheckRbacFeature extends UsercheckBaseFeature
{
    ...
    private function _required(UsercheckContext $ctx): ?string
    {
    ...
    private function _reject(UsercheckContext $ctx, string $required): void
    {
    ...
    private function _track(UsercheckContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
