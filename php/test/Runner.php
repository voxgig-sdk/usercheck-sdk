...
class UsercheckTestRunner
{
    ...
    {
        $live = self::getenv('USERCHECK_TEST_LIVE');
        $override = self::getenv('USERCHECK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('USERCHECK_TEST_EXPLAIN');
...
class_alias('UsercheckTestRunner', 'Runner');
class_alias('UsercheckHelpers', 'Helpers');
