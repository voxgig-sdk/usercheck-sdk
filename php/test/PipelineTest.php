...
{
    private static function utility(): UsercheckUtility
    {
        return new UsercheckUtility();
    }
    ...
    private static function ctx(array $over = []): UsercheckContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UsercheckContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UsercheckOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UsercheckError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UsercheckOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UsercheckMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UsercheckOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UsercheckMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UsercheckOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UsercheckMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UsercheckSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UsercheckMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UsercheckResponse([]),
            'result' => new UsercheckResult([]),
        ]);
        [, $err] = UsercheckMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UsercheckSpec([]),
            'response' => null,
            'result' => new UsercheckResult([]),
        ]);
        [, $err] = UsercheckMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UsercheckSpec(['step' => 's']),
            'response' => new UsercheckResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UsercheckResult([]),
        ]);
        [, $err] = UsercheckMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UsercheckSpec(['step' => 's']),
            'response' => new UsercheckResponse(self::resp(200, ['v' => 1])),
            'result' => new UsercheckResult([]),
        ]);
        [, $err] = UsercheckMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UsercheckSpec(['step' => 's']),
            'response' => new UsercheckResponse(self::resp(200, ['v' => 2])),
            'result' => new UsercheckResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UsercheckMakeResponse::call($ctx);
    ...
    {
        $preset = new UsercheckResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UsercheckSpec([]),
            'response' => new UsercheckResponse([]),
            'result' => new UsercheckResult([]),
        ...
        [$got, $err] = UsercheckMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UsercheckResult([])]);
        [, $err] = UsercheckMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UsercheckSpec([]), 'result' => null]);
        [, $err] = UsercheckMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UsercheckSpec(['step' => 's']),
            'result' => new UsercheckResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UsercheckOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UsercheckMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UsercheckSpec(['step' => 's']),
            'result' => new UsercheckResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UsercheckOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UsercheckMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UsercheckResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UsercheckSpec([]),
            'result' => new UsercheckResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UsercheckMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UsercheckMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UsercheckError('boom', 'boom');
        $utility->fetcher = function (UsercheckContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UsercheckSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UsercheckMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UsercheckContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UsercheckMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UsercheckResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UsercheckContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UsercheckSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UsercheckMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UsercheckResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UsercheckSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UsercheckMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UsercheckMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UsercheckMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UsercheckResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UsercheckDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UsercheckResult(['ok' => false])]);
        $this->expectException(UsercheckError::class);
        UsercheckDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UsercheckResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UsercheckMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UsercheckMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UsercheckBaseFeature();
        $b = new UsercheckBaseFeature();
        UsercheckFeatureAdd::call($ctx, $a);
        UsercheckFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UsercheckBaseFeature
    {
        $f = new UsercheckBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UsercheckFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UsercheckContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UsercheckSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UsercheckPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UsercheckResponse(['headers' => null]),
            'result' => new UsercheckResult([]),
        ]);
        UsercheckResultHeaders::call($ctx);
