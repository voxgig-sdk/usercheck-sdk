...
// Usercheck SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UsercheckSDK::test)
...
{
    private const SDK_CLASS = 'UsercheckSDK';
    ...
    private const SDK_BASE = 'usercheck_sdk';
