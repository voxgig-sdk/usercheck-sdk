...
// Usercheck SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UsercheckTransformResponse
{
    public static function call(UsercheckContext $ctx): mixed
    {
        ...
        $transform = UsercheckHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
