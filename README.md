...
The UserCheck API allows you to verify the validity of a domain by sending a simple GET request to the domain endpoint.

Learn more about UserCheck API at [docs.usercheck.com](https://docs.usercheck.com).
...
This SDK exposes the API as a small set of **semantic entities** — Domain — that you
...
| --- | --- | --- |
| **Domain** | The Domain entity (load). | `/domain/{domain}` |
