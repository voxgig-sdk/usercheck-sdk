...
Results: Domain verification successful.
...
| --- | --- | --- | --- |
| Domain | `load` | `GET /domain/{domain}` | See reference |

## Connect to the API

- Production server: `https://api.usercheck.com`
...
- `usercheck_list`: List records for an entity. No active entity supports this operation.
- `usercheck_load`: Load one record for an entity. Supported entities: `domain`.
