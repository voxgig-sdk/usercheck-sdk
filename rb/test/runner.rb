...
module UsercheckTestRunner
  ...
  def self.env_override(m)
    live = getenv("USERCHECK_TEST_LIVE")
    override = getenv("USERCHECK_TEST_OVERRIDE")
    ...
    explain = getenv("USERCHECK_TEST_EXPLAIN")
    m["USERCHECK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = UsercheckTestRunner
Helpers = UsercheckHelpers
Vs = VoxgigStruct
