...
func registerSDKWords(r *eng.Registry, client *sdk.UsercheckSDK) {
...
func runOp(client *sdk.UsercheckSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
