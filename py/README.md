# Usercheck Python SDK



The Python SDK for the Usercheck API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/usercheck-sdk/releases)) or
...
```
py/
├── usercheck_sdk.py         -- Main SDK module
