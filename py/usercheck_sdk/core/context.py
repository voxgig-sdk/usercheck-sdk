...
from usercheck_sdk.core.helpers import get_ctx_prop, to_map
...
class UsercheckContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UsercheckSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UsercheckResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UsercheckResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UsercheckError(code, msg, self)
