...
from usercheck_sdk.utility import register

# Load features
from usercheck_sdk.feature.base_feature import UsercheckBaseFeature
from usercheck_sdk.features import _has_feature, _make_feature
...
class UsercheckSDK:
    ...
    def get_utility(self):
        return UsercheckUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UsercheckSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from usercheck_sdk.entity.domain_entity import DomainEntity
