# Usercheck SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UsercheckSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UsercheckSDK(...) and UsercheckSDK.test(...) become
#      UsercheckSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "usercheck_sdk"
_SDK_CLASS = "UsercheckSDK"
