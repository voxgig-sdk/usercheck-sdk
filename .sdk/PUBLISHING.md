...
|---|---|---|
| `ts/` | @voxgig-sdk/usercheck-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/usercheck-sdk \
      --repository voxgig-sdk/usercheck-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/usercheck-sdk` shows it, and
`npm trust revoke @voxgig-sdk/usercheck-sdk --id=<id>` removes it.
