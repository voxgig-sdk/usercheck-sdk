...
// Usercheck SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UsercheckTestFeature extends UsercheckBaseFeature
{
    ...
    public function init(UsercheckContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UsercheckContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UsercheckParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UsercheckContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UsercheckContext $ctx, $op, $args): array
    {
