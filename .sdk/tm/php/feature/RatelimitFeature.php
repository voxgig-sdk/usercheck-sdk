...
// Usercheck SDK ratelimit feature
...
class UsercheckRatelimitFeature extends UsercheckBaseFeature
{
    ...
    private function _acquire(UsercheckContext $ctx): void
    {
    ...
    private function _track(UsercheckContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
