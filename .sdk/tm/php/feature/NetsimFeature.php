...
class UsercheckNetsimFeature extends UsercheckBaseFeature
{
    ...
    private function _simulate(UsercheckContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UsercheckContext $ctx, array $applied): void
    {
        $client = $this->client;
