...
// Usercheck SDK clienttrack feature
...
class UsercheckClienttrackFeature extends UsercheckBaseFeature
{
    ...
    public function PostConstruct(UsercheckContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Usercheck-SDK';
