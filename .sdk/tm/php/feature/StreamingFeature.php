...
// Usercheck SDK streaming feature
...
class UsercheckStreamingFeature extends UsercheckBaseFeature
{
    ...
    private function _iterate(UsercheckResult $result): \Generator
    {
    ...
    private function _streamable(UsercheckContext $ctx): bool
    {
