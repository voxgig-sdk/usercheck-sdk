...
class UsercheckTimeoutFeature extends UsercheckBaseFeature
{
    ...
    private function _with_timeout(UsercheckContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UsercheckContext $_ctx, float $ms): void
    {
        $client = $this->client;
