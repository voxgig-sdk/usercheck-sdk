...
// Usercheck SDK utility: fetcher

class UsercheckFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UsercheckSDK/1.0)';
    ...
    public static function call(UsercheckContext $ctx, string $fullurl, array $fetchdef): array
    {
