...
class UsercheckGraphql
{
    ...
    // equivalent.
    public static function body(UsercheckContext $ctx): mixed
    {
    ...
    public static function errors(UsercheckContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
