...
// Usercheck SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UsercheckOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UsercheckOmni::structfix($now, Struct::undef()))
                        !== json_encode(UsercheckOmni::structfix($val, Struct::undef()))) {
