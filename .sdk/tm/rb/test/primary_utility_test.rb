...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = UsercheckOmni.make_runner(TEST_JSON_FILE, UsercheckSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : UsercheckOmni.errify(err)
    end
