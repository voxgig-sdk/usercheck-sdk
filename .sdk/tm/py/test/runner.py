...
class UsercheckTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UsercheckTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UsercheckTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UsercheckTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
