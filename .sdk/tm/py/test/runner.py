...
class UsercheckTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UsercheckTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UsercheckTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UsercheckTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
