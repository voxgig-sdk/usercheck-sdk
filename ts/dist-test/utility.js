...
function envOverride(m) {
    if ('TRUE' === process.env.USERCHECK_TEST_LIVE ||
        'TRUE' === process.env.USERCHECK_TEST_OVERRIDE) {
    ...
    m.USERCHECK_TEST_EXPLAIN = process.env.USERCHECK_TEST_EXPLAIN || m.USERCHECK_TEST_EXPLAIN;
    return m;
}
