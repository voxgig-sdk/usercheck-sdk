...
(0, node_test_1.describe)('DomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UsercheckSDK({
...
function liveScenariosActive() { return false && process.env.USERCHECK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UsercheckSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['USERCHECK_TEST_DOMAIN_ENTID'];
    ...
    const client = new __1.UsercheckSDK({
        base: 'http://localhost:8080',
