...
func (sdk *UsercheckSDK) OptionsMap() map[string]any {
...
func (sdk *UsercheckSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UsercheckSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UsercheckSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UsercheckSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UsercheckSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UsercheckSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UsercheckSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UsercheckSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UsercheckSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UsercheckSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
