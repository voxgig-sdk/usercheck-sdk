...
type Args struct {
	Entity string         `json:"entity" jsonschema:"domain"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UsercheckSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "usercheck_list",
		Description: "List records from Usercheck. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "usercheck_load",
		Description: "Load a single record from Usercheck. " +
...
func runOp(client *sdk.UsercheckSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UsercheckSDK, name string) (sdk.UsercheckEntity, error) {
