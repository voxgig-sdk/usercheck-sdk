...
local UsercheckSDK = {}
UsercheckSDK.__index = UsercheckSDK
...
UsercheckSDK._make_feature = _make_feature


function UsercheckSDK.new(options)
  local self = setmetatable({}, UsercheckSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function UsercheckSDK:options_map()
...
function UsercheckSDK:get_utility()
  return Utility.copy(self._utility)
end


function UsercheckSDK:get_root_ctx()
  return self._rootctx
end


function UsercheckSDK:prepare(fetchargs)
...
function UsercheckSDK:direct(fetchargs)
...
-- by passing it.
function UsercheckSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function UsercheckSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "UsercheckSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function UsercheckSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = UsercheckSDK.new(sdkopts)
  sdk.mode = "test"
